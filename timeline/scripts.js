document.addEventListener("DOMContentLoaded", () => {
    const eventsData = {
        "2012": [
            { type: "catastrophe", text: "Декабрь: Группа сталкеров уничтожает Черное Сердце, что провоцирует глобальный энергетический выброс." },
        ...
        "2018": [
            ...
            { type: "political", text: "Декабрь: В Китае начинаются массовые протесты против правительства. Южные провинции требуют большей автономии, что приводит к первым признакам распада страны." }
        ],
        "2019": [
            ...
            { type: "political", text: "Декабрь: Китай официально распадается на несколько независимых государств: Северный Китай, Южный Альянс и Тибетскую Республику. Начинаются вооружённые конфликты между новыми образованиями." }
        ],
        "2020": [
            ...
            { type: "political", text: "Декабрь: Северный Китай начинает военную экспансию в попытке восстановить контроль над южными провинциями, но сталкивается с сопротивлением Южного Альянса." }
        ],
        "2021": [
            ...
            { type: "political", text: "Декабрь: Тибетская Республика объявляет о своей независимости и начинает строительство пси-барьеров для защиты от внешних угроз." }
        ],
        "2022": [
            ...
            { type: "political", text: "Декабрь: Южный Альянс и Тибетская Республика заключают договор о ненападении, что стабилизирует ситуацию в регионе." }
        ],
        "2023": [
            ...
            { type: "political", text: "Декабрь: Северный Китай начинает проект 'Интеграция', направленный на синхронизацию человека и кристаллов, что вызывает массовые протесты." }
        ],
        "2024": [
